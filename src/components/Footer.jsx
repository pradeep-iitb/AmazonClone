...
import { Get_to_Know_Us, Connect_with_Us , Make_Money_with_Us , Let_us_Help_You } from '../constants/index.js';
...
const Footer = () => {
  ...
  <div className="language bg-[#222f3e] flex flex-row justify-center items-center w-full text-white border-t-[#5e646a] border-t-2 gap-10 relative top-30">
    ...
    <div className="languageandcountry flex flex-row justify-center items-center space-x-4 p-5">
      <button className='bg-[#222f3e] flex flex-row justify-center items-center py-2 px-8 rounded-md border-2 border-[#5e646a]'> <AiOutlineGlobal />
